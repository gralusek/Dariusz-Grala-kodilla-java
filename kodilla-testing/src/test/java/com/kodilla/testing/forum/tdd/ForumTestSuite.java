...
public class ForumTestSuite {
    ...
    class TestPosts {
        ...
        void testAddPost() {
            ...
            //When
            forumUser.addPost("mrsmith", "Hello everyone, this is my first comment");
            //Then
        ...
        void testGetPost() {
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello, this is my first contributin here", "mrsmith");
